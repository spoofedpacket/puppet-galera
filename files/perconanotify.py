...
MAIL_FROM = 'percona@example.com'
# Takes a list of recipients
MAIL_TO = ['notify@example.com']
...
def main(argv):
    ...
    if(len(opts) > 0):
        ...
        try:
            send_notification(MAIL_FROM, MAIL_TO, 'Percona Notification: ' + THIS_SERVER,
...
class GaleraStatus:
    ...
    def __str__(self):
        message = "Percona running on " + self._server + " has reported the following"
